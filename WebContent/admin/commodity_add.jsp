...
<body>
    ...
    <form action="commodityServlet" method="post" enctype="multipart/form-data">
    	<input name="mark" value="saveCommodity" type="hidden" />
	    <ul class="forminfo">
	    	 ...
	    	 <li>
	    	 	...
	    	 	<select name="gid" class="dfinput">
	    	 		...
	    	 		<c:forEach items="${categoryList }" var="cate">
	    	 			<option value="${cate.gid }">${cate.name }</option>
	    	 		</c:forEach>
