...
<body>
   ...
   <h3>${user.name }用户测试</h3>
    <div class="plus5_no3">
        <div class="plus5_no3_img">
            <img width="560px" height="560px" src="<%=imgPath %>/img/${commodity.pic}" style="display: block" alt="">
        </div>
        <div class="plus5_no3_right">
            ...
            <div class="plus5_no3_right_div10">
                <p class="plus5_no3_right_div10_p1">${commodity.name } <span class="plus5_no3_right_div10_span0">${commodity.version }</span> 
                <span class="plus5_no3_right_div10_span1"></span>
                <span class="plus5_no3_right_div10_span2">${commodity.color }</span>
                </p>
                <span class="plus5_no3_right_span10">${commodity.price }元</span>
                <p class="plus5_no3_right_div10_p2" style="font-size: 18px;font-weight: bold;">总计 ：${commodity.price } 元</p>

            </div>
            <a href="javascript:void(0)" >
            <div class="plus5_no3_right_div11" style="cursor: pointer;" onclick="buyProduct()" >加入购物车</div></a>
...
//        var value = $(".plus5_no3_right_div7_span0 ").htmlR();
        console.log($(this).childre().eq(1).html());
...
var buyProduct=function(){
	if(${user !=null}){
		...
		$.get("troll",{"mark":"addProductToTrolley","cid":cid},function(data){
