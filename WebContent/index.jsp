...
<body style="background-color: #fafafa;">
   ...
   <%--   <jsp:forward page="admin?mark=tologin"></jsp:forward> 
    ...
    <div class="scroll">
        ...
        <div class="scroll_left" style="height: 420px;">
            ...
            <c:forEach items="${catelist }" var="cate">
            	 <li class="scr_li"><a href="commodityServlet2?mark=commodityCategoryId&gid=${cate.gid }">${cate.name }</a><i class="scr_i"></i></li>
            </c:forEach>
    ...
    <div class="time">
        ...
        <div class="time_in">
        	    <!-- 动态数据时使用，已经修改过css -->
				<c:forEach items="${star_product }" var="commodity">
		            <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
		            	<a href="commodityServlet2?mark=findGoodsDetail&cid=${commodity.cid }" target="_blank">
		            		<img class="time_min" style="width:234px;height: 234px;" src="http://localhost:8080/img/${commodity.pic }" alt="">
		            	</a>
		            	<div style="clear: both;"></div>
		             	...
		             	<div style="width: 234px;height: 85px;">
		            		...
		            		<div style="width: 234px;height: 30px;line-height: 30px;text-align: center;color: #ff6700;font-size: 14px;font-family: Arial">
		            			 <span style="color: #000"> &nbsp;${commodity.price }</span>
		            		</div>
		            		<div style="width: 234px;height: 35px;line-height: 35px;text-align: center;color: #000;font-size: 14px;font-family: Arial" title="????">
		            			
		            			<c:if test="${commodity.description.length() <=12 }">
		            				${commodity.description}
		            			</c:if>
		            			<c:if test="${commodity.description.length() > 12 }">
		            				${ fn:substring(commodity.description ,0,12)}...
		            			</c:if>
		            		</div>
		            	</div> 
                ...
                <div class="appr">
                    <div class="appr_top">
                    	<!-- 循环后台取到的家电的集合 -->
                    		...
                    		<!-- 动态获取数据时使用，已经修改过css -->
                   			<!-- 动态获取数据时使用，已经修改过css -->
                   			<c:forEach items="${home_appliance }" var="comm" varStatus="i">
                  			<c:choose>
                  			<c:when test="${i.count <=4 }">
	                  			...
	                  			<a href="commodityServlet2?mark=findGoodsDetail&cid=${comm.cid }" target="_blank"><img width="180px" height="180px;" src="http://localhost:8080/img/${comm.pic}" alt=""></a>
	                  			
	                  			<div style="width: 234px;height: 100px;">
	                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${comm.name }</div>
	                  				...
	                  				<div style="width: 100%;height: 33px;text-align: center;color: #ff6700;font-size: 14px;font-family: Arial">${comm.price}</div>
	                  			</div>
	                  			</div>
                  			</c:when>
                  			<c:otherwise>
                  			     ...
                  			     <a href="commodityServlet2?mark=findGoodsDetail&cid=${comm.cid }"><img width="180px" height="180px;" src="http://localhost:8080/img/${comm.pic}" alt=""></a>
                  				 <div style="width: 234px;height: 100px;">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${comm.name }</div>
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">
									<c:if test="${comm.description.length() > 12 }">
        ...
        <div class="capacity">
            <div class="capa_box_top">
            	...
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
                    ...
                    <c:forEach items="${intel_Product }" var="comm1">
                   		 <div class="capa capa_shadow" style="width: 231px;height: 301px;text-align: center;background-color: #FFFFFF;margin-top: 15px;">
	                        <a href="commodityServlet2?mark=findGoodsDetail&cid=${comm1.cid }" target="_blank">
	                        <img width="180px" height="180px" src="http://localhost:8080/img/${comm1.pic}">
	                            <div class="tran">
	                        ...
	                        <div class="capa_a">
	                            <ul>
	                                <li style="color: #333333">${comm1.name }</li>
	                                <li style="color: #b0b0b0">${comm1.description}</li>
	                                <li style="font-size: 14px;margin-top: 10px; color: #ff6700" >${comm1.price }元</li>
	                            </ul>
	                        </div>
	                    </div>
	                  </c:forEach> 
        ...
        <div class="capacity">
            ...
            <div class="capa_box">
                <div class="capa_top">
					...
					<!-- 动态数据使用，仅供参考 -->
					<c:forEach items="${recommend }" var="comm2">
	                	<div class="capa capa_shadow" style="margin-right: 10px;background-color: #fff">
	                        <a href="commodityServlet2?mark=findGoodsDetail&cid=${comm2.cid }">
	                        <img width="234"  src="<%=imgPath %>/img/${comm2.pic}">
	                           
	                        </a>
	                        <div class="capa_a">
	                            <ul>
	                                <li style="color: #333333"> ${comm2.name } </li>
	                                <li style="color: #b0b0b0"> ${comm2.description } </li>
	                                <li style="font-size: 14px;margin-top: 10px; color: #ff6700">${comm2.price } 元</li>
	                            </ul>
	                        </div>
	                    </div>
                	</c:forEach>
    ...
    <div class="popular">
        <div class="popular_background">
            ...
            <div class="popu_box">
            	...
            	<!-- 动态数据使用，仅供参考 -->
            	 <c:forEach items="${hot }" var="goods" varStatus="i">
            		
            		<c:if test="${i.count ==1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="commodityServlet2?mark=findGoodsDetail&cid=${goods.cid }" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath %>/img/${goods.pic}"></a>
            			...
            			<div class="popu popu_unleft popu_shadow" style="margin-left: 13px;">
	                        <a href="commodityServlet2?mark=findGoodsDetail&cid=${goods.cid }" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath %>/img/${goods.pic}"></a>
		                        <div class="popu_bottom">
		                            ...
		                            <div class="info">
		                                <h3 class="title">
		                                <c:if test="${goods.name.length() > 12 }">
		            						${ fn:substring(goods.name ,0,11)}...
		            				    </c:if>
		            				</h3>
		                                <span class="sep">|</span>
		                                <p class="price"><span>${goods.price }</span>元</p>
